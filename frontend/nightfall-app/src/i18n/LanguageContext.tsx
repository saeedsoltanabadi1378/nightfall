...
const translations = {
  en: {
    ...
    needPlayers: "Need at least {min} players ({count}/{min})", waitingCreatorStart: "Waiting for the game creator to start.",
    ...
    timedDiscuss: "Each living player gets 60 seconds. An accepted challenge gets 40 seconds.", speakerTurn: "Speaker turn", challengeTurn: "Challenge", finishSpeaking: "Finish early",
    requestChallenge: "Request challenge", cancelChallenge: "Cancel challenge", challengeRequests: "Challenge requests", accept: "Accept", reject: "Reject",
  ...
  fa: {
    ...
    needPlayers: "حداقل {min} بازیکن لازم است ({count}/{min})", waitingCreatorStart: "در انتظار شروع بازی توسط سازنده.",
    ...
    timedDiscuss: "هر بازیکن زنده ۶۰ ثانیه و چالش پذیرفته‌شده ۴۰ ثانیه زمان دارد.", speakerTurn: "نوبت صحبت", challengeTurn: "چالش", finishSpeaking: "پایان زودتر",
    requestChallenge: "درخواست چالش", cancelChallenge: "لغو چالش", challengeRequests: "درخواست‌های چالش", accept: "پذیرش", reject: "رد",
